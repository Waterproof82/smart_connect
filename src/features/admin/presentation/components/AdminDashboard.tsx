          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              <button
                ...
                className="p-2 text-muted hover:text-red-400 hover:bg-[var(--color-surface)] focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400 rounded-lg transition-colors"
                title="Cerrar sesión"
        ...
        <div className="md:flex md:items-center md:justify-between mb-2">
          <div>
            ...
            <p className="text-muted text-sm mt-1">
              Chatbot RAG - Gestiona documentos y embeddings
            </p>
          </div>
        </div>
