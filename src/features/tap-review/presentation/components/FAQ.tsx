  ...
  return (
    <>
      <SeoFaqSchema
        faqs={[
          {
            question: DOMPurify.sanitize(t.tapReviewFAQ1Question),
            answer: DOMPurify.sanitize(t.tapReviewFAQ1Answer),
          },
          {
            question: DOMPurify.sanitize(t.tapReviewFAQ2Question),
            answer: DOMPurify.sanitize(t.tapReviewFAQ2Answer),
          },
          {
            question: DOMPurify.sanitize(t.tapReviewFAQ3Question),
            answer: DOMPurify.sanitize(t.tapReviewFAQ3Answer),
          },
        ]}
      />
