  ...
  const products = [
    {
      ...
      image: '/assets/nfc/S0c0ed93c21c345e7ad3f8895ff09cec43.jpg_640x640q75.jpg_.avif',
    ...
    },
    {
      ...
      image: '/assets/nfc/Se5c21071b09f40a2bd15019ea423800eb.jpg_640x640q75.jpg_.avif',
      alt: t.tapReviewProductExhibitorBlackAlt,
      fallback: '/assets/Tarjeta_NFC_negra_MontesTAP.webp'
    },
    {
      name: t.tapReviewProductStand,
      image: '/assets/nfc/S3c28dfdc8fbc4adcaab2a58f3b235ca6m.jpg_640x640q75.jpg_.avif',
      alt: t.tapReviewProductStandAlt,
      fallback: '/assets/Tarjeta_NFC_negra_MontesTAP.webp'
    },
    {
      name: t.tapReviewProductExhibitorWhite,
      image: '/assets/nfc/S90c19838ba374d069994fec4075ffca20.jpg_640x640q75.jpg_.avif',
      alt: t.tapReviewProductExhibitorWhiteAlt,
      fallback: '/assets/Tarjeta_NFC_negra_MontesTAP.webp'
    }
  ];
              ...
              <div className="mt-6 w-full h-48 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-2xl flex items-center justify-center overflow-hidden p-2">
                {imageErrors[idx] ? (
                  <div className="text-center p-4">
                    ...
                    <p className="text-xs text-muted font-medium">Paso {idx + 1}</p>
                  </div>
                ) : (
                  <img
                    src={step.image}
        ...
        <div className={`relative bg-gradient-to-br from-[var(--color-accent)] to-[var(--color-primary)] rounded-3xl p-12 md:p-16 text-center transition-all duration-1000 overflow-hidden ${
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={whatsappPhone ? `https://wa.me/${whatsappPhone}` : '#contacto?servicio=Tap%20Review%20NFC'}
                target="_blank"
