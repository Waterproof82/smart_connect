/**
 * TpvCobroSection — bespoke module section for the "tpv-cobro" entry of
 * TPV_MODULES (design.md D1/D4). Real, original copy with a CSS/lucide-icon
 * bullet visual, plus a self-hosted photo via TpvModuleFigure and a
 * per-module OKLCH accent (design.md D3/D5/D6 — visual redesign PR1 pilot).
 */
...
const BULLET_ICONS = [CreditCard, Receipt, Wallet, ShieldCheck];

const TpvCobroSection: React.FC<TpvModuleSectionProps> = ({
  whatsappPhone,
}) => {
  const { t } = useLanguage();

  const bullets = [
    { title: t.tpvCobroBullet1Title, desc: t.tpvCobroBullet1Desc },
    { title: t.tpvCobroBullet2Title, desc: t.tpvCobroBullet2Desc },
    { title: t.tpvCobroBullet3Title, desc: t.tpvCobroBullet3Desc },
...
export default TpvCobroSection;
