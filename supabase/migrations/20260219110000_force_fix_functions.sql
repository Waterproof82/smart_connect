-- Force fix all function types - drop all overloads and recreate
...
-- ============================================
-- DROP clean_expired_embedding_cache if table doesn't exist
-- ============================================
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP FUNCTION IF EXISTS clean_expired_embedding_cache();
  END IF;
END $$;
